...
class RubiksCube222EnvLBLPPOBN(RubiksCube222EnvB):
    def __init__(self, reward_model):
        super(RubiksCube222EnvLBLPPOBN, self).__init__()
        self.FL = None
        self.OLL = None
    ...
    def reward(self):
        ...
        flatten_state = torch.Tensor(np.eye(6)[self.convert(self.cube)].flatten().tolist())
