...
# changes made: control number fo scrambles + types of scrambles (possible scrambles are combinations of F',R',U')
# changes to reward function: for simplicity -> solved states = 60, non-solved states result in a reward of -1
...
class RubiksCube222Env(gym.Env):
    ...
    def __init__(self):
        ...
        with open("rubiks_cube_222_states_FRU.pickle", "rb") as f:
    ...
    def reset_scramble(self, num_scramble, *, seed=None, options=None):
        ...
        self.algorithm(self.generate_scramble_num(num_scramble))
